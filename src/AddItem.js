...
const AddItem = () => {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            const response = await axios.post('https://backend-iuq5.vercel.app/api/upload', formData, {
                headers: {
    ...
    const fetchTableData = async () => {
        try {
            const response = await axios.get('https://backend-iuq5.vercel.app/api/product');
